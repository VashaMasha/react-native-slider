...
export default class Slider extends PureComponent {
  static propTypes = {
    ...
    /**
     * Sets size for the thumbImage.
     */
    thumbImageSize: Image.propTypes.source,
  ...
  _renderThumbImage = () => {
    var {thumbImage, thumbImageSize} = this.props;

    if (!thumbImage) return;

    return <Image source={thumbImage} style={{height: thumbImageSize || 20, width: thumbImageSize || 20 }}/>;
  };
}
